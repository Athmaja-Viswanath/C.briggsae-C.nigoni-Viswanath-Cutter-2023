...
## R Markdown
These are preliminary figures that are made using the data. These figures were then customized using Adobe Illustrator to make the final versions of the figure in the publication Viswanath, Athmaja, and Asher D. Cutter. "Regulatory divergence as a mechanism for X-autosome incompatibilities in Caenorhabditis nematodes." Genome Biology and Evolution 15.4 (2023): evad055.
...
NOTE: in the paper this is a represented as a bubbleplot (made in excel). 
...
NOTE: in the paper this is a represented as a bubbleplot (made in excel). Data used is in Table S5
